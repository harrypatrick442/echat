    ...
    public class AssociatesClientEndpoint
    {
            ...
            IClientEndpoint snippetsClientEndpoint)
        {
            ...
            _RemoveClientMessageTypeMappings = clientMessageTypeMappingsHandler.AddRange(new TupleList<string, DelegateHandleMessageOfType<TypeTicketedAndWholePayload>> { 
                { global::MessageTypes.MessageTypes.UsersGetAllAssociateEntries, GetAllAssociateEntries},
                { global::MessageTypes.MessageTypes.UsersGetPublicUserProfileSummarys, GetPublicUserProfileSummarys},
                { global::MessageTypes.MessageTypes.UsersGetMyAssociatesProfileSummaries, GetMyAssociatesProfileSummaries},
                { global::MessageTypes.MessageTypes.UsersGetAnotherUsersAssociatesUserProfileSummarys,GetAnotherUsersAssociatesUserProfileSummarys},
                { global::MessageTypes.MessageTypes.UsersRemoveAssociate,RemoveAssociate},
                { global::MessageTypes.MessageTypes.UsersDowngradeAssociation,DowngradeAssociation},
                { global::MessageTypes.MessageTypes.UsersGetUserProfile,GetUserProfile},
                { global::MessageTypes.MessageTypes.UsersGetMyUserProfile,GetMyUserProfile},
                { global::MessageTypes.MessageTypes.UsersModifyUserProfile,ModifyUserProfile},
                { global::MessageTypes.MessageTypes.UsersGetMyReceivedRequests, GetMyReceivedRequests},
                { global::MessageTypes.MessageTypes.UsersGetMySentRequests, GetMySentRequests},
                { global::MessageTypes.MessageTypes.UsersCancelSentRequest,CancelSentRequest},
                { global::MessageTypes.MessageTypes.UsersRejectRequest, RejectRequest},
                { global::MessageTypes.MessageTypes.UsersCounterRequest, CounterRequest},
                { global::MessageTypes.MessageTypes.UsersAlterAssociate, AlterRequest},
                { global::MessageTypes.MessageTypes.UsersAcceptRequest, AcceptRequest},
                { global::MessageTypes.MessageTypes.UsersRequestAssociate, RequestAssociate},
                { global::MessageTypes.MessageTypes.UsersInviteAssociateByUserId, InviteAssociate},
                { global::MessageTypes.MessageTypes.UsernameSearchSearch, HandleUsernameSearchSearch},
                { global::MessageTypes.MessageTypes.UserQuadTreeGet, HandleUserQuadTreeGet},
                { global::MessageTypes.MessageTypes.UserQuadTreeGetNEntries, HandleUserQuadTreeGetNEntries},
                { global::MessageTypes.MessageTypes.UserQuadTreeSet, HandleUserQuadTreeSet}
            });
        }
